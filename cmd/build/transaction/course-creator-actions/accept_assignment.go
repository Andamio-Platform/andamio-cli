...
func init() {
	AcceptAssignmentCmd.Flags().StringVar(&userAccessToken, "userAccessToken", "", "")
	AcceptAssignmentCmd.Flags().StringVar(&studentAlias, "studentAlias", "", "")
	AcceptAssignmentCmd.Flags().StringVar(&policy, "policy", "", "")
}
